"""
Direct download handler - wraps range_downloader with /Download URL logic.
"""
...
async def download_direct(
    ...
    """
    Download via Emby's /Items/{id}/Download API (original file).

    Args:
        url: Full download URL from get_download_url().
